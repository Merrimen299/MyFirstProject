<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px;">
    ...
    <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li class="nav-item mb-2">
            <a href="comments" class="link-dark text-decoration-none">
        ...
        <li class="nav-item mb-2">
            <a href="orders" class="link-dark text-decoration-none">
        ...
        <li class="nav-item mb-2">
            <a href="https://fitwear/user/liked" class="link-dark text-decoration-none">
        ...
        <li class="nav-item mb-2">
            <a href="https://fitwear/product/add" class="link-dark text-decoration-none">
                <img src="../../images/navbar/tshirt.png"> Товари
            </a>
        </li>
        <li class="nav-item mb-2">
            <a href="stats" class="link-dark text-decoration-none">
    ...
    <hr>
    <a href="https://fitwear/user/logout" class="link-dark text-decoration-none">
